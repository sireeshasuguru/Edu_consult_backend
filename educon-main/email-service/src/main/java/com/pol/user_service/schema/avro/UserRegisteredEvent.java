...
public class UserRegisteredEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3209000853624690419L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserRegisteredEvent\",\"namespace\":\"com.pol.user_service.schema.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserRegisteredEvent(java.lang.CharSequence name, java.lang.CharSequence email) {
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.pol.user_service.schema.avro.UserRegisteredEvent.Builder newBuilder() {
    return new com.pol.user_service.schema.avro.UserRegisteredEvent.Builder();
  }
   ...
   * @return A new UserRegisteredEvent RecordBuilder
   */
  public static com.pol.user_service.schema.avro.UserRegisteredEvent.Builder newBuilder(com.pol.user_service.schema.avro.UserRegisteredEvent.Builder other) {
    if (other == null) {
      return new com.pol.user_service.schema.avro.UserRegisteredEvent.Builder();
    } else {
      return new com.pol.user_service.schema.avro.UserRegisteredEvent.Builder(other);
    }
  }
   ...
   * @return A new UserRegisteredEvent RecordBuilder
   */
  public static com.pol.user_service.schema.avro.UserRegisteredEvent.Builder newBuilder(com.pol.user_service.schema.avro.UserRegisteredEvent other) {
    if (other == null) {
      return new com.pol.user_service.schema.avro.UserRegisteredEvent.Builder();
    } else {
      return new com.pol.user_service.schema.avro.UserRegisteredEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserRegisteredEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pol.user_service.schema.avro.UserRegisteredEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pol.user_service.schema.avro.UserRegisteredEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pol.user_service.schema.avro.UserRegisteredEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pol.user_service.schema.avro.UserRegisteredEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pol.user_service.schema.avro.UserRegisteredEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pol.user_service.schema.avro.UserRegisteredEvent.Builder clearEmail() {
      email = null;
